...
const PlaceDetails = ({place,select,refProp  })=>{
        ...
        <Card elevation={6}>
            ...
            <CardContent>
                ...
                <Box display='flex' justifyContent='space-between'>
                    ...
                    {/* <Typography gutterButtom varient='subtitle1'>out of {place.num_reviews}</Typography> */}
                </Box>
                <Box display='flex' justifyContent='space-between'>
                    <Typography varient='subtitle1'>Price</Typography>
                    <Typography gutterButtom varient='subtitle1'>{place.price_level}</Typography>
                </Box>
                <Box display='flex' justifyContent='space-between'>
                    <Typography varient='subtitle1'>Ranking</Typography>
                    <Typography gutterButtom varient='subtitle1'>{place.ranking}</Typography>
                </Box>
